...
<p>На данном этаже вы договариваетесь со вторым пристом и с танками, кто в какой зоне стоит, подбираете сферы и перемещаетесь в указанную зону. Покидаете вы эту зону только в случае, если в ей произойдёт взрыв. После взрыва вы возвращаетесь обратно.</p>
...
<p>Помимо автокаста реса, также не рекомендуется ставить на автокаст <img src="./aspersio.png" width="50" height="50"/> Aspersio (Асперзио), так как она автоматом будет вешаться и на мехов, что будет снижать их урон.</p>
