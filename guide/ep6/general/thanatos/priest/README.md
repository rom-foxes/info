...
<p>Под танков также можно класть <img src="./sw.png" width="50" height="50"/> Safety Wall (Защитная стена), которая защищает их от визического урона от боссов. У визов тоже есть такое умение, поэтому не стесняйтесь просить их тоже к4идать его под танка.</p>
...
<p>Ингда бывает такое, что взрыв происходит во внутреннем круге, а во внешнем при выходе тоже возникает красная зона, куда будет скастовано АоЕ. Чтобы избежать чрезмерного количества смертей, прист должен поставить на красную зону дерево, а вся патька должна встать рядом с ним. Так многие смогут пережить это АоЕ.</p>
