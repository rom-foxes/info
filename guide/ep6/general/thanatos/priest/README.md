...
<p>Помимо автокаста реса, также не рекомендуется вешать на автокаст <img src="./aspersio.png" width="50" height="50"/> Aspersio (Асперзио), так как она автоматом будет вешаться и на мехов, что будет снижать их урон.</p>
