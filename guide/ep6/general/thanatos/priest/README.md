...
<p>Под танков также можно класть <img src="./sw.png" width="50" height="50"/> Safety Wall (Защитная стена), которая защищает их от физического урона от боссов. У визов тоже есть такое умение, поэтому не стесняйтесь просить их тоже к4идать его под танка.</p>
