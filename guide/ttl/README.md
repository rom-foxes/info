...
<li>
<p><img src="./pillar.png" width="100" height="150"/> Столб (пиллар). Появяется по периметру внутреннего сектора. Когда столб активен, боссы бессмертны. Необходимо уничтожить его как можно быстрее.</p>
</li>
<li>
