...
<ul>
<li>
<p><strong><img src="./link.png" width="100" height="100"/> Watcher's chains</strong> - Связывает двух персонажей нитью. Чем больше растояние, тем больший урон получают цели. Если расстояние слишком большое, то цели может шотнуть сразу после связки.</p>
</li>
<li>
<p><strong><img src="./ar.png" width="100" height="100"/>Arcane Rend</strong> - вертикальные лучи, которые преследуют двух персонажей. Урон достаточно большой, поэтому рекомендуется, что человек, за которым идёт этот луч, не стоял в патьке, а бегал отдельно от них, но не слишком далеко, чтобы не убила возможная связка.</p>
</li>
<li>
...
<p><img src="./zone.png" width="200" height="200"/></p>
